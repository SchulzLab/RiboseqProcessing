...
# plot_dir = '/projects/splitorfs/work/Riboseq/Output/HUVEC_CM_round_2/CM/alignment_concat_transcriptome_Ignolia/Ribowaltz'
# bam_dir <- "/projects/splitorfs/work/Riboseq/Output/HUVEC_CM_round_2/CM/alignment_concat_transcriptome_Ignolia/filtered/q10/dedup"
...
reads_list <- bamtolist(bamfolder = bam_dir, annotation = annotation_df)
