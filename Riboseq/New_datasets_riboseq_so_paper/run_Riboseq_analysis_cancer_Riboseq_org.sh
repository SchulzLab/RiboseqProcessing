...
# bash /home/ckalk/scripts/SplitORFs/Riboseq/Michi_Vlado_round_1/Riboseq_pipeline.sh -i "$meta_stat_breast_cancer_data_dir" -o "$out_dir" -c

# bash /home/ckalk/scripts/SplitORFs/Riboseq/Michi_Vlado_round_1/Riboseq_pipeline.sh -i "$glioblastoma_data_dir" -o "$out_dir" -c

bash /home/ckalk/scripts/SplitORFs/Riboseq/Michi_Vlado_round_1/Riboseq_pipeline.sh -i "$breast_cancer_data_dir" -o "$out_dir" -c -l 45